...
# This is a comprehensive mapping based on the commit history
...
# Create a script to filter commit messages
create_filter_script() {
    cat > filter-commits.sh << 'EOF'
#!/bin/bash
...
echo "Done! All commit messages have been translated to English."
